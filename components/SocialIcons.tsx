...
export function InstagramIcon({ size = 16 }: SocialIconProps) {
  return (
    <View style={{ width: size, height: size }}>
      <Svg width={size} height={size} viewBox="0 0 16 16">
        <Defs>
          <LinearGradient id="igGradient" x1="0" y1="0" x2="1" y2="1">
            <Stop offset="0" stopColor={Brand.btnPrimaryGradientStart} />
            <Stop offset="0.55" stopColor={Brand.secondaryGradientEnd} />
            <Stop offset="1" stopColor={Brand.accentOrange} />
          </LinearGradient>
        </Defs>
        <Path
...
// Snapchat icon using Bootstrap SVG - forced white color
